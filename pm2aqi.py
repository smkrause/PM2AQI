...
class PM2AQIApp(QWidget):
    ...
    def init_ui(self):
        ...
        summary_layout.addWidget(self.o_temp_label)
        summary_layout.addWidget(self.i_temp_label)
        summary_layout.addWidget(self.humidity_label)
        summary_layout.addWidget(self.wind_label)
        summary_layout.addWidget(self.rain_label)
    ...
    def update_summary(self, data):
        ...
        self.humidity_label.setText(f"Humidity: {data.get('humidity', '--')} %")
