...
class Dashboard(QWidget):
    ...
    def init_ui(self):
        ...
        wind_unit.setAlignment(Qt.AlignmentFlag.AlignRight)
        ...
        pressure_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        pressure_unit.setAlignment(Qt.AlignmentFlag.AlignRight)
        ...
        self.uv_level.setAlignment(Qt.AlignmentFlag.AlignRight)
        ...
        light_unit.setAlignment(Qt.AlignmentFlag.AlignRight)
    ...
    async def async_fetch(self):
        ...
        # Force use of pytz for consistency with pm2aqi.py
